Feature: Saucedemo workflow

  Scenario: Successful Login
    Given I am on the Demo Login Page
    When I fill the account information for account "standard_user" into the Username field and the Password field "secret_sauce"
  ...
  Scenario: Failed Login
    Given I am on the Demo Login Page
     When I fill the account information for lock account "locked_out_user" into the Username field and the Password field "secret_sauce"
     And I click the Login Button
